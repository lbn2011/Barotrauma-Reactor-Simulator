...
const componentIds = {
  ...
  sensor: ['temperatureSensor', 'pressureSensor', 'levelSensor', 'flowSensor'],
  controller: ['reactorController', 'turbineController', 'feedwaterController'],
...
function handleTriggerFault () {
  ...
  log.success('Fault triggered successfully', {
    faultType: selectedFaultType,
    componentId: selectedComponentId,
    severity: selectedSeverity,
  });
...
<div class="panel-container">
    ...
    <div class="status-card">
      ...
      <div class="status-grid">
        ...
        <div class="status-item">
          ...
          <div class={`status-value risk-level risk-${faultSimulation.riskLevel}`}>
    ...
    <div class="status-section">
      <div class="status-card">
        ...
        <ul class="actions-list">
          {#each faultSimulation.recommendedActions as action, i (i)}
  ...
  <div class="fault-section">
    ...
    <div class="fault-form">
      <div class="form-group">
        ...
        >
          {#each faultTypes as type (type.value)}
      ...
      <div class="form-group">
        ...
        >
          {#each componentIds[selectedFaultType as keyof typeof componentIds] as component (component)}
      ...
      <div class="form-actions">
        <button class="form-button btn-primary" on:click={handleTriggerFault}> 触发故障 </button>
  ...
  <div class="fault-list">
    ...
    {#if faultSimulation.activeFaults.length > 0}
      {#each faultSimulation.activeFaults as fault (fault.id)}
        {#if fault.status === 'active'}
          <div class="fault-item">
            ...
            <div class="fault-actions">
              <button class="form-button btn-secondary" on:click={() => fixFault(fault.id)}>
                修复故障
              </button>
            </div>
          </div>
