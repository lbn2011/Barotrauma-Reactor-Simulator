				...
				series: [
					{
						...
						type: 'line',
						data: [
							5000, 5200, 5500, 5800, 6000, 6200, 6500, 6800, 7000, 7200, 7500, 7800,
							8000, 8200, 8500, 8800, 9000, 9200, 9500, 9800, 10000, 10200, 10500, 10800
						],
						itemStyle: {
							color: '#ff4500'
						},
				...
				series: [
					{
						...
						data: [
							...
							80, 85, 90, 95, 100, 95, 90, 85, 80, 75, 70, 65
						],
						itemStyle: {
							color: '#0066cc'
						}
					},
					{
						...
						data: [
							...
							75, 80, 85, 90, 95, 90, 85, 80, 75, 70, 65, 60
						],
						itemStyle: {
							color: '#00cc66'
						}
