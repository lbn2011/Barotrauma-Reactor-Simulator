  ...
  const mockCarouselItems: CarouselItem[] = [
    {
      ...
      artwork: {
        template: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=reactor%20control%20panel%20with%20control%20rods%20and%20power%20gauges&image_size=landscape_16_9',
      },
    },
    {
      id: 2,
      ...
      artwork: {
        template: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=turbine%20control%20room%20with%20speed%20and%20load%20indicators&image_size=landscape_16_9',
      },
    },
    {
      id: 3,
      ...
      artwork: {
        template: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cooling%20system%20diagram%20with%20pumps%20and%20heat%20exchangers&image_size=landscape_16_9',
      },
    },
  ];
</script>
...
<ResponsiveContainer>
  <div class="overview-container">
    ...
    <p class="page-description">{$i18nStore.t('This is the overview page for the reactor simulator.')}</p>
